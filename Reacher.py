...
if __name__ == '__main__':
    ...
    parser.add_argument('--n-episodes', help='number of episodes', default=200, type=int)
    parser.add_argument('--checkpoint-prefix', help='prefix of checkpoint filename', default='')
    parser.add_argument('--load-checkpoint', help='', dest='load_checkpoint', action='store_true')
    ...
    agent = ddpg(nS=state_size, nA=action_size, random_seed=2, load_checkpoint=args.load_checkpoint,
                 checkpoint_prefix=args.checkpoint_prefix)
    episode_scores, average_scores = train_agent()
